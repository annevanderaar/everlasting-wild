...
export default function Hero() {
    return (
        <section className="ew-gradient-soft overflow-hidden">
            <div className="mx-auto grid min-h-[calc(100vh-100px)] max-w-7xl items-center gap-12 px-4 py-20 lg:grid-cols-[1.05fr_0.95fr]">
                <div>
                    ...
                    <p className="mt-6 max-w-2xl text-lg leading-8 text-gray-600">
                        Ik ontwerp en ontwikkel moderne websites en webapplicaties met focus op design,
                        performance en gebruiksvriendelijkheid.
                    </p>
